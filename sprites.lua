-- Sprite palettes and 20x20 pixel art, one entry per Pokemon in data.lua order.
-- Loaded once on a first launch for the renderer, then the global SPR is cleared.
SPR={
